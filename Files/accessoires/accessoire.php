...
<html>
  ...
  <body>
    ...
    <div id="element">
      <?php include_once('../../sql/accessoire_sql.php'); ?>
      <div id="commentaire">
        <textarea name="comments" id="comments" tyle="text" placeholder="Comments" cols="96" rows="2" value=""></textarea>
  ...
  <?php
     $id= $_GET['id'];
     click_plus($id, $_SESSION['Libelle'.$id]);
  ?>
</html>
